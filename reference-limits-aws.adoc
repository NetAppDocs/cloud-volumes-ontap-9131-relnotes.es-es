...
|===
. La profundidad de los clones jerárquicos es la profundidad máxima de una jerarquía anidada de los volúmenes FlexClone que se puede crear desde un único volumen FlexVol
